"""Sidecar persistence — Cloak's private store, kept separate from the transcript.
...
The user's stored Buzz transcript is never touched — this is Cloak's own working
